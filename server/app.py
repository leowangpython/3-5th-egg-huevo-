...
#county
counties_in_states = {}
counties_spreadsheet = load_workbook(os.path.abspath("server/list-counties-us-436j.xlsx")).active
...
#city
cities_in_states = {}
cities_spreadsheet = load_workbook(os.path.abspath("server/uscities.xlsx")).active
